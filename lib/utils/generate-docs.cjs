...
const awsProviderVer = 'v24.05.00230';
...
function createInsertExample(serviceName, resourceName, resourceData, thisSchema, allSchemas) {
    ...
    function templateObjectValues(obj) {
        ...
        return JSON.stringify(templatedObj, null, 1);
    }
...
${codeBlockStart}
<<<json
${templateObjectValues(resolveType(thisSchema, true))}
>>>
...
${codeBlockStart}
<<<json
${templateObjectValues(resolveType(thisSchema, false))}
>>>
--all properties
INSERT INTO ${providerName}.${serviceName}.${resourceName} (
