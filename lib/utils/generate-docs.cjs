...
<div class="row">
<div class="providerDocColumn">
${generateResourceLinks(serviceName, resources)}
</div>
<div class="providerDocColumn">
${generateResourceLinks(serviceName, resources)}
</div>
...
function generateResourceLinks(serviceName, resources) {
    ...
    const resourceLinks = resources.map((resource) => {
        return `<a href="/providers/azure/${serviceName}/${resource.name}/">${resource.name}</a>`;
    });
...
<div class="row">
<div class="providerDocColumn">
<span>resource type:&nbsp;<b>${serviceName}.${resourceName}</b></span><br />
<span>resource id:&nbsp;<b>${serviceName}:${resourceName}</b></span><br />
</div>
</div>
...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>${serviceName}.${resourceName}</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Description</b></td><td>${schema.description || ''}</td></tr>
<tr><td><b>Id</b></td><td><code>${serviceName}:${resourceName}</code></td></tr>
</tbody></table>
