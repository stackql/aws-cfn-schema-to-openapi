...
export function generateStackqlViews(openApiSpec) {
  ...
  topLevelSchemas.forEach(([schemaName, schema]) => {
    ...
    if (isCreateSupported) {
      ...
      // create faux schema
      // openApiSpec.components.schemas[`Create${schemaName}Request`] = {
      //   properties: {
      //     ClientToken: {
      //       type: 'string'
      //     },
      ...
      // create faux path
      // openApiSpec.paths[`/?Action=CreateResource&Version=2021-09-30&__${schemaName}&__detailTransformed=true`] = {
      //   parameters: [
      //     {
      ...
      //         required: false,
      //         schema: {
      //           default: `CloudApiService.Create${schemaName}`,
      //           enum: [
      //             `CloudApiService.Create${schemaName}`
      //           ],
      //           type: "string"
      //         }
      //       },
            ...
            parameters: [
              {
                ...
                schema: {
                  default: `CloudApiService.Create${schemaName}`,
                  enum: [`CloudApiService.Create${schemaName}`],
                  type: "string"
                }
              },
              {
    ...
    // Assuming 'openApiSpec' is your OpenAPI Specification object and 'schemaName' is defined in your context
    // if (schemaName !== 'Analyzer') {
    //   delete openApiSpec.paths['/?Action=CreateResource&Version=2021-09-30&__Analyzer&__detailTransformed=true'];
    // }
