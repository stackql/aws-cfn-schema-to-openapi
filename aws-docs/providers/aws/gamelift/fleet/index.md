...
<tr><td><code>instance_role_credentials_provider</code></td><td><code>string</code></td><td>Credentials provider implementation that loads credentials from the Amazon EC2 Instance Metadata Service.</td></tr>
